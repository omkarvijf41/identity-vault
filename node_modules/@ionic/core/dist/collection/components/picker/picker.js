...
export class Picker {
  ...
  render() {
    ...
    return (h(Host, Object.assign({ "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
        ...
        [`picker-${mode}`]: true }, getClassMap(this.cssClass)), onIonBackdropTap: this.onBackdropTap, onIonPickerWillDismiss: this.dispatchCancelHandler }),
  ...
  static get properties() { return {
    ...
    "htmlAttributes": {
      ...
      "mutable": false,
      "complexType": {
        "original": "PickerAttributes",
        "resolved": "PickerAttributes | undefined",
        "references": {
          "PickerAttributes": {
            "location": "import",
            "path": "../../interface"
