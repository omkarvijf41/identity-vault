...
export class Toast {
  ...
  renderButtons(buttons, side) {
    ...
    return (h("div", { class: buttonGroupsClasses }, buttons.map(b => h("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: "button" },
      h("div", { class: "toast-button-inner" },
        b.icon &&
          h("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-button-icon" }),
        b.text),
  ...
  render() {
    ...
    return (h(Host, Object.assign({ role: role, tabindex: "-1" }, this.htmlAttributes, { style: {
      ...
      }, class: createColorClasses(this.color, Object.assign(Object.assign({ [mode]: true }, getClassMap(this.cssClass)), { 'toast-translucent': this.translucent })), onIonToastWillDismiss: this.dispatchCancelHandler }),
      h("div", { class: wrapperClass },
        h("div", { class: "toast-container", part: "container" },
          this.renderButtons(startButtons, 'start'),
          this.icon !== undefined &&
            h("ion-icon", { class: "toast-icon", part: "icon", icon: this.icon, lazy: false, "aria-hidden": "true" }),
  ...
  static get properties() { return {
    ...
    "htmlAttributes": {
      ...
      "complexType": {
        ...
        "resolved": "ToastAttributes | undefined",
        "references": {
          "ToastAttributes": {
            "location": "import",
