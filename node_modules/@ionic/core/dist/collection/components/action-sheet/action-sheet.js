...
export class ActionSheet {
      ...
      h("div", { class: "action-sheet-wrapper ion-overlay-wrapper", role: "dialog", ref: el => this.wrapperEl = el },
        h("div", { class: "action-sheet-container" },
          h("div", { class: "action-sheet-group", ref: el => this.groupEl = el },
            ...
            buttons.map(b => h("button", { type: "button", id: b.id, class: buttonClass(b), onClick: () => this.buttonClick(b) },
  ...
  static get properties() { return {
    ...
    "htmlAttributes": {
      ...
      "mutable": false,
      "complexType": {
        "original": "ActionSheetAttributes",
        "resolved": "ActionSheetAttributes | undefined",
        "references": {
