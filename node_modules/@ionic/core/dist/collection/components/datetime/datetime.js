...
import { is24Hour } from './utils/helpers';
...
import { getCalendarDayState, isDayDisabled } from './utils/state';
/**
...
export class Datetime {
  ...
  renderYearView() {
    ...
    return (h("div", { class: "datetime-year" },
      h("div", { class: "datetime-year-body" },
    ...
    return (h("div", { class: "calendar-header" },
      h("div", { class: "calendar-action-buttons" },
        ...
        h("div", { class: "calendar-next-prev" },
          h("ion-buttons", null,
            h("ion-button", { onClick: () => this.prevMonth() },
              h("ion-icon", { slot: "icon-only", icon: chevronBack, lazy: false })),
            h("ion-button", { onClick: () => this.nextMonth() },
              h("ion-icon", { slot: "icon-only", icon: chevronForward, lazy: false }))))),
  ...
  renderTimePicker(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return (h("ion-picker-internal", null,
      h("ion-picker-column-internal", { color: color, value: workingParts.hour, items: hoursItems, numericInput: true, onIonChange: (ev) => {
