...
export class Alert {
  ...
  renderAlertButtons() {
    ...
    return (h("div", { class: alertButtonGroupClass }, buttons.map(button => h("button", { type: "button", id: button.id, class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) },
  ...
  static get properties() { return {
    ...
    "htmlAttributes": {
      ...
      "mutable": false,
      "complexType": {
        "original": "AlertAttributes",
        "resolved": "AlertAttributes | undefined",
        "references": {
          "AlertAttributes": {
            "location": "import",
