...
const index$1 = require('./index-1ee97147.js');
const ionicGlobal = require('./ionic-global-b8cea456.js');
...
const overlays = require('./overlays-13c51bd6.js');
const animation = require('./animation-abbf2fb2.js');
...
let Datetime = class {
  ...
  renderYearView() {
    ...
    return (index.h("div", { class: "datetime-year" }, index.h("div", { class: "datetime-year-body" }, index.h("ion-picker-internal", null, showMonth &&
      index.h("ion-picker-column-internal", { color: this.color, items: months, value: workingParts.month, onIonChange: (ev) => {
      ...
      index.h("ion-picker-column-internal", { color: this.color, items: years, value: workingParts.year, onIonChange: (ev) => {
  ...
  renderMonth(month, year) {
    ...
    return (index.h("div", { class: "calendar-month" }, index.h("div", { class: "calendar-month-grid" }, getDaysOfMonth(month, year, this.firstDayOfWeek % 7).map((dateObject, index$1) => {
      ...
      return (index.h("button", { tabindex: "-1", "data-day": day, "data-month": month, "data-year": year, "data-index": index$1, "data-day-of-week": dayOfWeek, disabled: isMonthDisabled || disabled, class: {
  ...
  renderTimePicker(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return (index.h("ion-picker-internal", null, index.h("ion-picker-column-internal", { color: color, value: workingParts.hour, items: hoursItems, numericInput: true, onIonChange: (ev) => {
        this.setWorkingParts(Object.assign(Object.assign({}, this.workingParts), { hour: ev.detail.value }));
        this.setActiveParts(Object.assign(Object.assign({}, this.activeParts), { hour: ev.detail.value }));
        ev.stopPropagation();
      } }), index.h("ion-picker-column-internal", { color: color, value: workingParts.minute, items: minutesItems, numericInput: true, onIonChange: (ev) => {
        this.setWorkingParts(Object.assign(Object.assign({}, this.workingParts), { minute: ev.detail.value }));
        this.setActiveParts(Object.assign(Object.assign({}, this.activeParts), { minute: ev.detail.value }));
        ev.stopPropagation();
      } }), !use24Hour && index.h("ion-picker-column-internal", { color: color, value: workingParts.ampm, items: ampmItems, onIonChange: (ev) => {
        const hour = calculateHourFromAMPM(this.workingParts, ev.detail.value);
        this.setWorkingParts(Object.assign(Object.assign({}, this.workingParts), { ampm: ev.detail.value, hour }));
        this.setActiveParts(Object.assign(Object.assign({}, this.workingParts), { ampm: ev.detail.value, hour }));
        ev.stopPropagation();
      } })));
  }
  renderTimeOverlay(hoursItems, minutesItems, ampmItems, use24Hour) {
    return [
      ...
      index.h("ion-popover", { alignment: "center", translucent: true, overlayIndex: 1, arrow: false, style: {
          '--offset-y': '-10px'
        }, ref: el => this.popoverRef = el }, this.renderTimePicker(hoursItems, minutesItems, ampmItems, use24Hour))
    ];
  }
  /**
