...
let Slides = class {
  ...
  connectedCallback() {
    ...
    if (typeof MutationObserver !== 'undefined') {
      ...
      helpers.componentOnReady(this.el, () => {
        if (!this.didInit) {
          this.didInit = true;
          this.initSwiper();
        }
  ...
  async initSwiper() {
    ...
    // init swiper core
    // @ts-ignore
    const { Swiper } = await Promise.resolve().then(function () { return require('./swiper.bundle-3e3b5fcf.js'); });
...
const waitForSlides = (el) => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => helpers.componentOnReady(s, resolve))));
};
Slides.style = {
  ios: slidesIosCss,
  md: slidesMdCss
