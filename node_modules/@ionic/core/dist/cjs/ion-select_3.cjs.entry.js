...
let SelectPopover = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: ionicGlobal.getIonMode(this) }, index.h("ion-list", null, header !== undefined && index.h("ion-list-header", null, header), hasSubHeaderOrMessage &&
      index.h("ion-item", null, index.h("ion-label", { class: "ion-text-wrap" }, subHeader !== undefined && index.h("h3", null, subHeader), message !== undefined && index.h("p", null, message))), this.renderOptions(options))));
  }
};
SelectPopover.style = {
