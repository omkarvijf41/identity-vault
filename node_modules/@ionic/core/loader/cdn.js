...
exports.defineCustomElements = function(_, opts) {
  return new Promise(function(resolve, reject) {
    if (typeof document !== 'undefined') {
      ...
      mod['data-opts'] = opts;
      mod.src = 'https://cdn.jsdelivr.net/npm/@ionic/core@6.0.0-rc.2/dist/ionic/ionic.esm.js';

      var legacy = document.createElement('script');
      legacy.setAttribute('nomodule', '');
      legacy['data-opts'] = opts;
      legacy.src = 'https://cdn.jsdelivr.net/npm/@ionic/core@6.0.0-rc.2/dist/ionic/ionic.js';
