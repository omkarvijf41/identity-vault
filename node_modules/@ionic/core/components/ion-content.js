 ...
 */
import { createEvent, readTask, forceUpdate, h, Host, proxyCustomElement } from '@stencil/core/internal/client';
...
let Content = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
Content = /*@__PURE__*/ proxyCustomElement(Content, [1, "ion-content", {
    "color": [513],
    "fullscreen": [4],
    ...
    "scrollByPoint": [64],
    "scrollToPoint": [64]
  }, [[8, "appload", "onAppLoad"], [2, "click", "onClick"]]]);
