...
import { e as renderHiddenInput, g as getElementRoot } from './helpers.js';
...
let Datetime = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
let datetimeIds = 0;
Datetime = /*@__PURE__*/ proxyCustomElement(Datetime, [33, "ion-datetime", {
    "color": [1],
    "name": [1],
    "disabled": [4],
    "readonly": [4],
