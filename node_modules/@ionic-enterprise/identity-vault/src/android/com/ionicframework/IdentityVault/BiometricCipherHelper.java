...
public class BiometricCipherHelper {
    ...
    public static Cipher getCypherForDecryption(String key, String deviceSecurityType, byte[] iv) throws VaultError {
        try {
            Cipher cipher = getCipher();
            SecretKey secretKey = getOrCreateKey(key, deviceSecurityType);
    ...
    public static Cipher getCypherForEncryption(String key, String deviceSecurityType) throws VaultError {
        try {
            Cipher cipher = getCipher();
            SecretKey secretKey = getOrCreateKey(key, deviceSecurityType);
    ...
    private static SecretKey getOrCreateKey(String key, String deviceSecurityType) throws VaultError {
