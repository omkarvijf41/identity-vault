...
public class IdentityVaultConfig {
    ...
    IdentityVaultConfig(JSONObject json) throws JSONException {
        ...
        this.androidBiometricsPreferStrongVaultOrSystemPasscode = json.optString("androidBiometricsPreferStrongVaultOrSystemPasscode", "StrongVault");
