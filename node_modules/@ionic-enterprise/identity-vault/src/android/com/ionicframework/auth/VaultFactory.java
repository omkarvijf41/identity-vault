...
public class VaultFactory extends SharedPreferenceVaultFactory {
    ...
    private static IonicVault getInMemKeychainVault(Context context, String prefFileName, String keyAlias, int authDurationSeconds) {
        IonicKeyStorage keyStorage = new IonicKeychainAuthenticatedStorage(
            keyAlias,
            EncryptionConstants.AES_CIPHER,
            EncryptionConstants.BLOCK_MODE_CBC,
            EncryptionConstants.ENCRYPTION_PADDING_PKCS7,
            authDurationSeconds
        );

        IonicVault ionicVault = new IonicSharedPreferenceVault(
            context,
            keyStorage,
            prefFileName,
    ...
    public static IonicVault getPasscodeVault(Context context, String descriptor) {
        ...
        return new IonicSharedPreferenceVault(
            context,
            keyStorage,
            String.format(PASSCODE_PREF_NAME, descriptor),
            EncryptionConstants.AES_CBC_PADDED_TRANSFORM,
            true
        );
    }
