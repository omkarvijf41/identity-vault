...
public class VaultAppConfig {
    ...
    public static void configure(JSONObject config, Activity activity) {
        ...
        instance.shouldClearVaultAfterTooManyFailedAttempts =
            config.optBoolean("shouldClearVaultAfterTooManyFailedAttempts", instance.shouldClearVaultAfterTooManyFailedAttempts);
