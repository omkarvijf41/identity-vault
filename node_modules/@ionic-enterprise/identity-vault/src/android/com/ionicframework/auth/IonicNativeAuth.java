...
public class IonicNativeAuth extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
        ...
        } else if (action.equals("setHideScreenOnBackground")) {
    ...
    private void isBiometricsSupported(JSONArray args, CallbackContext callbackContext) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            boolean result =
                ...
                mCurrentVault.getAvailableHardware().length() != 0;
    ...
    private void setHideScreenOnBackground(JSONArray args, CallbackContext callbackContext) {
        try {
            setCurrentVaultFromArgs(args);
            boolean enabled = getPositionalArg(args, 1, "enabled", Boolean.class);
            mCurrentVault.setHideScreenOnBackground(enabled);
            success(callbackContext);
        } catch (VaultError e) {
            error(callbackContext, e);
        }
    ...
    private void setPasscode(JSONArray args, CallbackContext callbackContext) {
        try {
            ...
            if (passcode != null) {
                ...
                AuthPINDialog.PasscodeDialogCallback callback = new PasscodeCallback(mCurrentVault, callbackContext, true);
    ...
    private <T extends Object> T getPositionalArg(JSONArray args, int index, String name, Class<T> type, T defaultTo)
