...
function AuthVault(options) {
  return {
    ...
    isLockedOutOfBiometrics: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isLockedOutOfBiometrics', [
            descriptor,
          ]);
        });
      });
    ...
    getToken: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(unwrapData('token', resolve), reject, PLUGIN_NAME, 'getValue', [
            descriptor,
            'token',
          ]);
        });
    ...
    storeToken: function (token) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'storeValue', [
            descriptor,
            'token',
            token,
          ]);
    ...
    getValue: function (key) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(unwrapData(key, resolve), reject, PLUGIN_NAME, 'getValue', [
            descriptor,
            key,
          ]);
        });
    ...
    getAvailableHardware: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'getAvailableHardware', [
            descriptor,
          ]);
        });
      });
    ...
    isBiometricsAvailable: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isBiometricsAvailable', [
            descriptor,
          ]);
        });
      });
    ...
    isBiometricsSupported: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isBiometricsSupported', [
            descriptor,
          ]);
        });
      });
    ...
    setBiometricsEnabled: function (isBiometricsEnabled) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'setBiometricsEnabled', [
            descriptor,
            isBiometricsEnabled,
          ]);
        });
    ...
    setHideScreenOnBackground: function (enabled) {
        var descriptor = this.descriptor;
        return this._setupPromise.then(function () {
          return new Promise(function (resolve, reject) {
            exec(resolve, reject, PLUGIN_NAME, 'setHideScreenOnBackground', [
              descriptor,
              enabled,
            ]);
          });
    ...
    isBiometricsEnabled: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isBiometricsEnabled', [
            descriptor,
          ]);
        });
      });
    ...
    isSecureStorageModeEnabled: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isSecureStorageModeEnabled', [
            descriptor,
          ]);
        });
      });
    ...
    setSecureStorageModeEnabled: function (enable) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'setSecureStorageModeEnabled', [
            descriptor,
            enable,
          ]);
        });
    ...
    setPasscodeEnabled: function (enable) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'setPasscodeEnabled', [
            descriptor,
            enable,
          ]);
        });
    ...
    setPasscode: function (passcode) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'setPasscode', [
            descriptor,
            passcode,
          ]);
        });
    ...
    isPasscodeSetupNeeded: function () {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'isPasscodeSetupNeeded', [
            descriptor,
          ]);
        });
      });
    ...
    unlock: function (withPasscode, passcode) {
      ...
      return this._setupPromise.then(function () {
        return new Promise(function (resolve, reject) {
          exec(resolve, reject, PLUGIN_NAME, 'unlock', [
            descriptor,
            withPasscode,
            passcode,
          ]);
