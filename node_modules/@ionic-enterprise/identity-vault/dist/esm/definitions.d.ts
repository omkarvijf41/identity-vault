 ...
 */
export declare enum SupportedBiometricType {
 ...
 */
export declare enum BiometricSecurityStrength {
 ...
 * @default `Both`
 */
export declare enum DeviceSecurityType {
 ...
 * @default `StrongVault`
 */
export declare enum AndroidBiometricCryptoPreference {
 ...
 * @ignore
 */
export declare type BiometricType = 'touchID' | 'faceID' | 'none';
/**
