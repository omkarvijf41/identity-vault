"use strict";
(self["webpackChunkgetting_started_iv_angular"] = self["webpackChunkgetting_started_iv_angular"] || []).push([["node_modules_ionic_core_dist_esm_ion-slide_2_entry_js"],{
...
let Slides = class {
  ...
  connectedCallback() {
    ...
    if (typeof MutationObserver !== 'undefined') {
      ...
      (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.el, () => {
        if (!this.didInit) {
          this.didInit = true;
          this.initSwiper();
        }
...
const waitForSlides = el => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_3__.c)(s, resolve))));
};
