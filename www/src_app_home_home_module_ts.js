...
/* harmony export */ });
/* harmony import */ var _Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 9369);
...
const createCapacitor = win => {
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const loadPluginImplementation = /*#__PURE__*/function () {
      var _ref = (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
  ...
  removeAllListeners() {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      _this2.listeners = {};
...
/* harmony export */   "VaultType": () => (/* binding */ VaultType)
/* harmony export */ });
/* harmony import */ var _Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 9369);
  ...
  handleError(resolve, reject, error, retryFunc) {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      if (error.code === VaultErrorCodes.MissingPasscode && _this.passCodeRequestedCallback) {
        ...
        cordova.exec( /*#__PURE__*/(0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
          const data = yield retryFunc();
          resolve(data);
...
/* harmony import */ var _Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_ngtools_webpack_src_loaders_direct_resource_js_home_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./home.page.html */ 2056);
...
let HomePage = class HomePage {
    ...
    setSession(data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            yield this.vaultService.setSession(data);
        });
    }
    restoreSession() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            yield this.vaultService.restoreSession();
        });
    }
    lockVault() {
...
HomePage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        selector: "app-home",
        template: _Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_ngtools_webpack_src_loaders_direct_resource_js_home_page_html__WEBPACK_IMPORTED_MODULE_0__.default,
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 3786);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 2316);
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/core */ 1899);
/* harmony import */ var _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-enterprise/identity-vault */ 1525);
...
let VaultService = class VaultService {
    ...
    init() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            yield this.platform.ready(); // This is required only for Cordova
            this.vault =
                _capacitor_core__WEBPACK_IMPORTED_MODULE_0__.Capacitor.getPlatform() === "web"
                    ? new _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__.BrowserVault(config)
                    : new _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__.Vault(config);
            this.vault.onLock(() => {
                this.ngZone.run(() => {
            ...
            this.state.privacyScreen = yield _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__.Device.isHideScreenOnBackgroundEnabled();
            this.state.canUseBiometrics = yield _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__.Device.isBiometricsEnabled();
            this.state.canUsePasscode = yield _ionic_enterprise_identity_vault__WEBPACK_IMPORTED_MODULE_1__.Device.isSystemPasscodeSet();
    ...
    setSession(value) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.vault.setValue(key, value);
            this.state.vaultExists = yield this.vault.doesVaultExist();
        });
    }
    restoreSession() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            const value = yield this.vault.getValue(key);
            this.state.session = value;
        });
    }
    lockVault() {
    ...
    setLockType() {
        ...
        this.vault.updateConfig(Object.assign(Object.assign({}, this.vault.config), { type, deviceSecurityType }));
    }
    clearVault() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
