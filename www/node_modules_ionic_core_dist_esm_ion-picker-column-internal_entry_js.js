...
/* harmony import */ var _haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-9a9aa7ec.js */ 3149);
...
let PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
      ...
      const scrollCallback = () => {
        (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          if (timeout) {
  ...
  get activeItem() {
    return (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]`);
  }
  render() {
