...
/* harmony import */ var _framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-c972cd13.js */ 6399);
/* harmony import */ var _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-6ff04165.js */ 8423);
/* harmony import */ var _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-7135448f.js */ 4348);
/* harmony import */ var _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./theme-a24ff1ad.js */ 1526);
/* harmony import */ var _index_2497e97d_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-2497e97d.js */ 5004);
/* harmony import */ var _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./animation-7e9a7324.js */ 4347);
/* harmony import */ var _cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cubic-bezier-154a53a5.js */ 214);
/* harmony import */ var _index_41bf41f2_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-41bf41f2.js */ 1483);
/* harmony import */ var _hardware_back_button_ace6a71b_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hardware-back-button-ace6a71b.js */ 7067);
/* harmony import */ var _gesture_controller_68c023a4_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./gesture-controller-68c023a4.js */ 9381);
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = detail => {
    const step = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.k)(0.0001, detail.deltaY / height, 0.9999);
  ...
  const gesture = (0,_index_41bf41f2_js__WEBPACK_IMPORTED_MODULE_10__.createGesture)({
    el,
...
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  const wrapperAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)');
  const wrapperAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
  const {
    wrapperAnimation,
    backdropAnimation
  ...
  const baseAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().afterStyles({
          'transform': finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          'transform': 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const createEnterAnimation = () => {
  const backdropAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)');
  const wrapperAnimation = (0,_animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
  ...
  const onEnd = detail => {
    ...
    animation.onFinish(() => {
      if (shouldRemainOpen) {
         ...
         */
        if (wrapperAnimation && backdropAnimation) {
          (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
            wrapperAnimation.keyframes([...SheetDefaults.WRAPPER_KEYFRAMES]);
            backdropAnimation.keyframes([...SheetDefaults.BACKDROP_KEYFRAMES]);
...
let Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
  ...
  componentDidLoad() {
     ...
     */
    if (this.isOpen === true) {
      (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.present());
    }
  ...
  present() {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this.usersElement = yield (0,_framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this.el, _this.component, ['ion-page'], data, inline);
      yield (0,_index_2497e97d_js__WEBPACK_IMPORTED_MODULE_7__.e)(_this.usersElement);
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      const enteringAnimation = _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.h.get(_this4) || [];
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
