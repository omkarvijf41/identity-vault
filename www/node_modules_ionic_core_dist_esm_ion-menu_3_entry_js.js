"use strict";
(self["webpackChunkgetting_started_iv_angular"] = self["webpackChunkgetting_started_iv_angular"] || []).push([["node_modules_ionic_core_dist_esm_ion-menu_3_entry_js"],{
...
/* harmony import */ var _gesture_controller_68c023a4_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gesture-controller-68c023a4.js */ 9381);
/* harmony import */ var _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers-6ff04165.js */ 8423);
/* harmony import */ var _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-b1478b64.js */ 7311);
/* harmony import */ var _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-a24ff1ad.js */ 1526);
/* harmony import */ var _hardware_back_button_ace6a71b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hardware-back-button-ace6a71b.js */ 7067);
/* harmony import */ var _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-7e9a7324.js */ 4347);
...
let Menu = class {
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.n)(this.side);
  }
...
`);
      ...
      _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._register(_this);

      _this.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-41bf41f2.js */ 1483))).createGesture({
        el: document,
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el, ['aria-label']);
  }
  ...
  disconnectedCallback() {
    ...
    _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._unregister(this);
  ...
  setOpen(shouldOpen, animated = true) {
    return _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._setOpen(this, shouldOpen, animated);
  }
  ...
  loadAnimation() {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this4.animation = yield _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._createAnimation(_this4.type, _this4);
  ...
  canStart(detail) {
    ...
    } else if (_index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._getOpenSync()) {
      return false;
    }
  ...
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.m)(false, 'isAnimating has to be true');
      return;
  ...
  onEnd(detail) {
    ...
    newStepValue += (0,_cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_3__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.k)(0, adjustedStepValue, 0.9999))[0] || 0;
  ...
  beforeAnimation(shouldOpen) {
    (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.m)(!this.isAnimating, '_before() should not be called while animating'); // this places the menu into the correct location before it animates in
  ...
  afterAnimation(isOpen) {
    (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.m)(this.isAnimating, '_before() should be called while animating'); // keep opening/closing the menu disabled for a touch more yet
  ...
  updateState() {
    ...
    if (!this.disabled) {
      _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m._setActiveMenu(this);
    }

    (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.m)(!this.isAnimating, 'can not be animating');
  }

  forceClosing() {
    (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_5__.m)(this._isOpen, 'menu cannot be closed');
    this.isAnimating = true;
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (menu) {
    const menuEl = yield _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m.get(menu);
...
let MenuButton = class {
  constructor(hostRef) {
    ...
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      return _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(_this6.menu);
    });
  }
...
let MenuToggle = class {
  constructor(hostRef) {
    ...
    this.onClick = () => {
      return _index_b1478b64_js__WEBPACK_IMPORTED_MODULE_6__.m.toggle(this.menu);
    };
  }
