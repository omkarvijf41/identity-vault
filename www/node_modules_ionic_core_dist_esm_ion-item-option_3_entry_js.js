...
let ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    const isEnd = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.n)(this.side);
    return (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      class: {
        [mode]: true,
...
let ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-41bf41f2.js */ 1483))).createGesture({
        el: _this2.el,
  ...
  updateOptions() {
    ...
    return (0,_Users_rachayya_kallimath_VOYA_WEB_getting_started_iv_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.n)(option.side) ? 'end' : 'start';
