(function () {
  ...
  (self["webpackChunkgetting_started_iv_angular"] = self["webpackChunkgetting_started_iv_angular"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"], {
    /***/
    15678: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./overlays-7135448f.js */
      44348);
      /* harmony import */
      ...
      var _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./animation-7e9a7324.js */
      4347);
      /* harmony import */


      var _cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./cubic-bezier-154a53a5.js */
      50214);
      /* harmony import */


      var _index_41bf41f2_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./index-41bf41f2.js */
      61483);
      /* harmony import */


      var _hardware_back_button_ace6a71b_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./hardware-back-button-ace6a71b.js */
      77067);
      /* harmony import */


      var _gesture_controller_68c023a4_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
        ...
        var onMove = function onMove(detail) {
          var step = (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.k)(0.0001, detail.deltaY / height, 0.9999);
        ...
        var onEnd = function onEnd(detail) {
          ...
          if (!shouldComplete) {
            ...
            newStepValue += (0, _cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_9__.g)([0, 0], [1, 0], [0.68, 0.28], [1, 1], step)[0];
          } else {
            animation.easing('cubic-bezier(0.32, 0.72, 0, 1)');
            newStepValue += (0, _cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_9__.g)([0, 0], [0.32, 0.72], [0, 1], [1, 1], step)[0];
          }
        ...
        var gesture = (0, _index_41bf41f2_js__WEBPACK_IMPORTED_MODULE_10__.createGesture)({
          el: el,
      ...
      var computeDuration = function computeDuration(remaining, velocity) {
        return (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.k)(400, remaining / Math.abs(velocity * 1.1), 500);
      };
      /**
       * Use y = mx + b to
      ...
      var createSheetEnterAnimation = function createSheetEnterAnimation(opts) {
        ...
        var backdropAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
        var wrapperAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('wrapperAnimation').keyframes([{
          offset: 0,
          opacity: 1,
      ...
      var createSheetLeaveAnimation = function createSheetLeaveAnimation(opts) {
        ...
        var backdropAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
        var wrapperAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('wrapperAnimation').keyframes([{
          offset: 0,
          opacity: 1,
          transform: "translateY(".concat(100 - currentBreakpoint * 100, "%)")
      ...
      var createEnterAnimation$1 = function createEnterAnimation$1() {
        var backdropAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)');
        var wrapperAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        return {
          backdropAnimation: backdropAnimation,
          wrapperAnimation: wrapperAnimation
        };
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, opts) {
        ...
        var root = (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
        ...
        var baseAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingElRoot = (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
          var presentingAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().afterStyles({
                'transform': _finalTransform
      ...
      var createLeaveAnimation$1 = function createLeaveAnimation$1() {
        var backdropAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
        var wrapperAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        return {
          backdropAnimation: backdropAnimation,
          wrapperAnimation: wrapperAnimation
        };
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, opts) {
        ...
        var baseAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingElRoot = (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
          var presentingAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
      ...
      var createEnterAnimation = function createEnterAnimation() {
        var backdropAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)');
        var wrapperAnimation = (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().keyframes([{
          offset: 0,
          opacity: 0.01,
      ...
      var mdEnterAnimation = function mdEnterAnimation(baseEl, opts) {
        ...
        return (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
      };
      ...
      var mdLeaveAnimation = function mdLeaveAnimation(baseEl, opts) {
        ...
        backdropAnimation.addElement(root.querySelector('ion-backdrop'));
        wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
        return (0, _animation_7e9a7324_js__WEBPACK_IMPORTED_MODULE_8__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
      };
      ...
      var createSheetGesture = function createSheetGesture(baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation) {
        ...
        var onMove = function onMove(detail) {
          ...
          offset = (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.k)(0.0001, initialStep + detail.deltaY / height, 0.9999);
        ...
        var onEnd = function onEnd(detail) {
          ...
          animation.onFinish(function () {
            if (shouldRemainOpen) {
               ...
               */
              if (wrapperAnimation && backdropAnimation) {
                (0, _helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_4__.r)(function () {
                  wrapperAnimation.keyframes(_toConsumableArray(SheetDefaults.WRAPPER_KEYFRAMES));
                  backdropAnimation.keyframes(_toConsumableArray(SheetDefaults.BACKDROP_KEYFRAMES));
      ...
      var Modal = /*#__PURE__*/function () {
        function Modal(hostRef) {
          ...
          this.coreDelegate = (0, _framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__.C)();
          ...
          this.configureTriggerInteraction = function () {
            ...
            _this5.destroyTriggerInteraction = configureTriggerInteraction(triggerEl, el);
          };

          this.onBackdropTap = function () {
            _this5.dismiss(undefined, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.B);
          };
        ...
        _createClass(Modal, [{
          ...
          value: function connectedCallback() {
            (0, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.e)(this.el);
          }
        }, {
          ...
          value: function present() {
            ...
            return (0, _Users_i711243_Desktop_projects_Duplicate_Projects_Identity_vault_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      _context.next = 5;
                      return _this.currentTransition;

                    case 5:
                      data = Object.assign(Object.assign({}, _this.componentProps), {
                        modal: _this.el
                      });
                      _this$getDelegate = _this.getDelegate(true), inline = _this$getDelegate.inline, delegate = _this$getDelegate.delegate;
                      _context.next = 9;
                      return (0, _framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this.el, _this.component, ['ion-page'], data, inline);

                    case 9:
                      _this.usersElement = _context.sent;
                      _context.next = 12;
                      return (0, _index_2497e97d_js__WEBPACK_IMPORTED_MODULE_7__.e)(_this.usersElement);

                    case 12:
                      (0, _index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.c)(function () {
                        return _this.el.classList.add('show-modal');
                      });
                      _this.currentTransition = (0, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.d)(_this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
          ...
          value: function initSwipeToClose() {
            ...
            var animationBuilder = this.leaveAnimation || _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.get('modalLeave', iosLeaveAnimation);
            ...
            this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
               ...
               */
              _this7.gestureAnimationDismissing = true;

              _this7.animation.onFinish( /*#__PURE__*/(0, _Users_i711243_Desktop_projects_Duplicate_Projects_Identity_vault_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          ...
          value: function initSheetGesture() {
            ...
            var animationBuilder = this.enterAnimation || _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.get('modalEnter', iosEnterAnimation);
            ...
            this.gesture = createSheetGesture(this.el, this.backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, ani, sortedBreakpoints, function () {
               ...
               * removed from the DOM.
               */
              _this8.gestureAnimationDismissing = true;

              _this8.animation.onFinish( /*#__PURE__*/(0, _Users_i711243_Desktop_projects_Duplicate_Projects_Identity_vault_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
              ...
              _this8.currentBreakpoint = breakpoint;
            });
            this.gesture.enable(true);
          }
          /**
          ...
          value: function dismiss(data, role) {
            ...
            return (0, _Users_i711243_Desktop_projects_Duplicate_Projects_Identity_vault_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
              var enteringAnimation, dismissed, _this4$getDelegate, delegate;
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 2:
                      ...
                      _context4.next = 5;
                      return _this4.currentTransition;

                    case 5:
                      enteringAnimation = _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.h.get(_this4) || [];
                      _this4.currentTransition = (0, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this4, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
                    ...
                    case 9:
                      ...
                      _this4$getDelegate = _this4.getDelegate(), delegate = _this4$getDelegate.delegate;
                      _context4.next = 14;
                      return (0, _framework_delegate_c972cd13_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
          ...
          value: function onDidDismiss() {
            return (0, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.el, 'ionModalDidDismiss');
          }
          /**
          ...
          value: function onWillDismiss() {
            return (0, _overlays_7135448f_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.el, 'ionModalWillDismiss');
          }
        }, {
          key: "render",
